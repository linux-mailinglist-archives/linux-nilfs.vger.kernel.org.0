Return-Path: <linux-nilfs+bounces-1631-lists+linux-nilfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nilfs@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id gPg1JfUqI2qhjgEAu9opvQ
	(envelope-from <linux-nilfs+bounces-1631-lists+linux-nilfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nilfs@lfdr.de>; Fri, 05 Jun 2026 22:00:53 +0200
X-Original-To: lists+linux-nilfs@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [IPv6:2600:3c15:e001:75::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 99DE564B14A
	for <lists+linux-nilfs@lfdr.de>; Fri, 05 Jun 2026 22:00:52 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=Nvidia.com header.s=selector2 header.b=DD2z4jsy;
	spf=pass (mail.lfdr.de: domain of "linux-nilfs+bounces-1631-lists+linux-nilfs=lfdr.de@vger.kernel.org" designates 2600:3c15:e001:75::12fc:5321 as permitted sender) smtp.mailfrom="linux-nilfs+bounces-1631-lists+linux-nilfs=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=reject) header.from=nvidia.com;
	arc=reject ("cv is fail on i=2")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 98129300E14E
	for <lists+linux-nilfs@lfdr.de>; Fri,  5 Jun 2026 20:00:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DECF83E1D05;
...
X-Spamd-Result: default: False [1.84 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-1631-lists,linux-nilfs=lfdr.de];
	FORGED_SENDER_MAILLIST(0.00)[];
	FORWARDED(0.00)[lists@lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	FORGED_SENDER(0.00)[ziy@nvidia.com,linux-nilfs@vger.kernel.org];
	...
	FROM_NEQ_ENVFROM(0.00)[ziy@nvidia.com,linux-nilfs@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
