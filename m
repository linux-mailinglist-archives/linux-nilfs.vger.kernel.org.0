...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E03C340A0EA
	for <lists+linux-nilfs@lfdr.de>; Tue, 14 Sep 2021 00:41:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1349146AbhIMWmt (ORCPT <rfc822;lists+linux-nilfs@lfdr.de>);
        Mon, 13 Sep 2021 18:42:49 -0400
Received: from mail.kernel.org ([198.145.29.99]:51756 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1344391AbhIMWkz (ORCPT <rfc822;linux-nilfs@vger.kernel.org>);
        Mon, 13 Sep 2021 18:40:55 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id 36EFC6136F;
        Mon, 13 Sep 2021 22:36:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1631572566;
        bh=rjUzc31mYN/iwJJ7u2RwyAx48k5rjUdwS0eIsz5aehE=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH AUTOSEL 4.4 3/8] nilfs2: fix memory leak in nilfs_sysfs_create_device_group
Date:   Mon, 13 Sep 2021 18:35:56 -0400
Message-Id: <20210913223601.436675-3-sashal@kernel.org>
...
+		goto cleanup_dev_kobject;
 	...
 	if (err)
@@ -1045,9 +1045,7 @@ int nilfs_sysfs_create_device_group(struct super_block *sb)
