Return-Path: <linux-nilfs+bounces-1267-lists+linux-nilfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nilfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id AFCAIJ7LoWnbwQQAu9opvQ
	(envelope-from <linux-nilfs+bounces-1267-lists+linux-nilfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nilfs@lfdr.de>; Fri, 27 Feb 2026 17:51:42 +0100
X-Original-To: lists+linux-nilfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id D612C1BB073
	for <lists+linux-nilfs@lfdr.de>; Fri, 27 Feb 2026 17:51:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 964D7315094A
	for <lists+linux-nilfs@lfdr.de>; Fri, 27 Feb 2026 16:47:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1DF67349B00;
...
Received: from smtp-relay-internal-1.canonical.com (smtp-relay-internal-1.canonical.com [185.125.188.123])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D2FC0358D0E
	for <linux-nilfs@vger.kernel.org>; Fri, 27 Feb 2026 16:47:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=pass smtp.client-ip=185.125.188.123
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1772210850; cv=pass; b=VpmaPlo5CVevmZ4lOtMKoayHx+7dcSLPrimNQg4Ae7twVTm5831Lgb6yllgUX0A1yjG6xh8/kALJz4zLb4t6zMa39gSwpFgStRJTA9rqRh7QnAwk03GDX9ePC5gIFoGIFfMvpHiHCCJi+AwYPu2YzOA3EprITfs5RBx9mvM2wbA=
...
Received: from mail-yx1-f69.google.com (mail-yx1-f69.google.com [74.125.224.69])
	...
	(No client certificate requested)
	by smtp-relay-internal-1.canonical.com (Postfix) with ESMTPS id D936940330
	for <linux-nilfs@vger.kernel.org>; Fri, 27 Feb 2026 16:47:12 +0000 (UTC)
...
Received: by mail-yx1-f69.google.com with SMTP id 956f58d0204a3-64ca2fce827so5119622d50.0
        for <linux-nilfs@vger.kernel.org>; Fri, 27 Feb 2026 08:47:12 -0800 (PST)
ARC-Seal: i=1; a=rsa-sha256; t=1772210831; cv=none;
        d=google.com; s=arc-20240605;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20240605;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version;
        bh=BKQzT9t7ZI3mb+6EDIKBTxaX0DX68JkIAcPYLBp08+M=;
        fh=rdCMLluftwuq9Y9GM8Y6FxzxEeed2dC8VsSyA0bUWnc=;
        b=;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=BKQzT9t7ZI3mb+6EDIKBTxaX0DX68JkIAcPYLBp08+M=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCV0+8zsn0fQLKf4WqhpUsXFJo85d1UHUTEs2PrDd+m+NBfOzIJjy6mKEeHGLA1XxCpMdS1+uKC5zZzBcQ==@vger.kernel.org
X-Gm-Message-State: AOJu0Yy9/xB2UUj6BY3Z5XOFs6NtUkWQrfB44ZBWG3wPASvSUegkT2ER
	3M0EGeXanGhZoV+C3g/1I8pUAQzPFemgJr//LhewhW2ZZwRoKeDiY9B4zcjj7QkhMDm+R98cCyN
	lY/X+Wg9TDoAtwV88z5UWZrV7j7Fgkz5iQhchVJ9jgqxx0dDIdW6nBsOIw3AJtYBIKtVe5Wl1q8
	W4c2nnAX3PO2TiknblFfsU1Jt3LEm1UadAgJY26SuLtl5b+E+7YfbMRl8=
X-Gm-Gg: 
X-Received: by 2002:a53:b743:0:b0:64c:9b84:92ee with SMTP id 956f58d0204a3-64cb6f438a9mr3821223d50.31.1772210830758;
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	FROM_HAS_DN(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-1267-lists,linux-nilfs=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	...
	FROM_NEQ_ENVFROM(0.00)[ryan.lee@canonical.com,linux-nilfs@vger.kernel.org];
