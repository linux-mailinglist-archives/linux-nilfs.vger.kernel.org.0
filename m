Return-Path: <linux-nilfs+bounces-1146-lists+linux-nilfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-nilfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id OIZVBZB9n2mrcQQAu9opvQ
	(envelope-from <linux-nilfs+bounces-1146-lists+linux-nilfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-nilfs@lfdr.de>; Wed, 25 Feb 2026 23:54:08 +0100
X-Original-To: lists+linux-nilfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 66A9719E7D0
	for <lists+linux-nilfs@lfdr.de>; Wed, 25 Feb 2026 23:54:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id CD628308DDAA
	for <lists+linux-nilfs@lfdr.de>; Wed, 25 Feb 2026 22:52:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DE2FE366814;
...
Received: from mail-qk1-f181.google.com (mail-qk1-f181.google.com [209.85.222.181])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B09CD36605D
	for <linux-nilfs@vger.kernel.org>; Wed, 25 Feb 2026 22:52:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.222.181
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1772059968; cv=none; b=AIsu+r+uXtDxNaq2rf5CwlnQjAsDbbmVamiOIMGzzGNo4uz6Cz3IbYhAhCeGxcDMs4bitwSZ45JPX2bi4zfX/UhUMlfxtHP9xlN/kcMCytbTNl/hxGg8BHXxTK4qrewqAR2St+gJsV/DzATz/PsjbK5/Gmeg58f6KfWefqVJdYE=
...
Received: by mail-qk1-f181.google.com with SMTP id af79cd13be357-8cb3e22435fso119030085a.1
        for <linux-nilfs@vger.kernel.org>; Wed, 25 Feb 2026 14:52:45 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:from:content-language
         ...
         :reply-to;
        bh=lV5yfIvdQy795zXZiEFYEcuoFYVuQqyybCf8AopsVu4=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVHL8n5PDcQ4QaG+qKBqveWXisrRE+9q/DA5gBFc9MCeby9thvNshxabL/W1dEDvIDN2Xs1wsdpxSrbAQ==@vger.kernel.org
X-Gm-Message-State: AOJu0YytOWOMecDtNS8Cv7UQHXONdfHFsn0Se6DQSeSekh0YDIJJ9Ghx
	U3aiwm0jSv8T5UOO7siDwhhnPpe1UJAUtDsToogter50pvpJZEbNbfOphGH4D+epppc=
X-Gm-Gg: 
	jNXRKCL
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-1146-lists,linux-nilfs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[columbia.edu:email,kernel-dk.20230601.gappssmtp.com:dkim,kernel.dk:mid,sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns]
X-Rspamd-Queue-Id: 66A9719E7D0
